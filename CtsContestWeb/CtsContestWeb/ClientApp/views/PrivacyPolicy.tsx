...
export default class PrivacyPolicy extends React.Component<any, any> {
    ...
    privacyPolicy = <div style={{margin:20}}><p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit <a href ='http://cognizantchallenge.lt'>cognizantchallenge.lt</a> (the “Site”).</p>
    ...
    <p>
    Additionally when you connect to the game through the Site, we collect certain information from you, including your name, e-mail address.
    </p>
    <p>
    When we talk about “Personal Information” in this Privacy Policy, we are talking both about Device Information and Information about you.
    </p>
    <h3>
    ...
    <li>When in line with the preferences you have shared with us, provide you with information or advertising relating to job vacancies, marketing campaigns.</li>
    </ul>
    </p>
    <p>
    ...
    <p>
    For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at <b>hello@cognizant.com</b> or send us letter
    </p>
    <p>
    Cognizant Lithuania
    </p>
